...
public final class data_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  String blView = ac.viewBlView(similar, (byte) 5, "Giao-duc");
  ...
  if (pos.equalsIgnoreCase("kinh-te") ) {
    //Kinh te
    similar.setArticle_category_id(230);
  ...
  if (pos.equalsIgnoreCase("suc-khoe") && size > 6) {
    //Suc khoe
    similar.setArticle_category_id(items.get(6).getCategory_id());
  ...
  if (pos.equalsIgnoreCase("phap-luat") && size > 7) {
    //Phap luat
    similar.setArticle_category_id(items.get(7).getCategory_id());
  ...
  if (pos.equalsIgnoreCase("giao-duc") && size > 8) {
    //Giao duc
    similar.setArticle_category_id(items.get(8).getCategory_id());
  ...
  if (pos.equalsIgnoreCase("khoa-hoc") && size > 9) {
    //Khoa hoc
    similar.setArticle_category_id(items.get(9).getCategory_id());
  ...
  if (pos.equalsIgnoreCase("du-lich") && size > 10) {
    //Du lich
    similar.setArticle_category_id(items.get(10).getCategory_id());
  ...
  if (pos.equalsIgnoreCase("the-gioi") && size > 11) {
    //The gioi
