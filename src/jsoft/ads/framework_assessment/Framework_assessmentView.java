...
public class Framework_assessmentView extends HttpServlet {
    ...
    private void view(HttpServletRequest request, HttpServletResponse response) throws
       ...
       Framework_assessmentControl cc = new Framework_assessmentControl(cp);

       if (cp == null) {
           getServletContext().setAttribute("CPool", cc.getCP());
       }
       //Lay cau truc HTML trinh bay
       String view = cc.viewFramework_assessments(null, (short) 1, (byte) 15);
