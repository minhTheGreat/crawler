...
public class SourceLibrary {
    ...
    public static String viewSourceNew(ArrayList<Assessment_ruleObject> items) {
        ...
        tmp +=
                "<div class=\"card-header\"><strong>Thêm ngu\u1ED3n tin</strong></div>";
        tmp += "<div class=\"card-body card-block\">";
        tmp += "<div class=\"form-group\">";
        tmp += "<label for=\"txtName\" class=\" form-control-label required\">Tên ngu\u1ED3n</label>";
        tmp += "<input type=\"text\" id=\"txtName\" name=\"txtName\" placeholder=\"Nh\u1EADp tên ngu\u1ED3n\" class=\"form-control\" required>";
        tmp += "</div>";
        tmp += "<div class=\"form-group\">";
        ...
        tmp += "</div>";
        tmp += "<div class=\"form-group\">";
        tmp += "<label for=\"txtCateSelector\" class=\" form-control-label required\">Xác \u0111\u1ECBnh chuyên m\u1EE5c</label>";
        tmp += "<input type=\"text\" id=\"txtCateSelector\" name=\"txtCateSelector\" placeholder=\"Nh\u1EADp CSS selector \u0111\u1EC3 xác \u0111\u1ECBnh chuyên m\u1EE5c c\u1EE7a ngu\u1ED3n\" class=\"form-control\" required>";
        tmp += "</div>";
        tmp += "<div class=\"form-group choose-categories\">";
        tmp += "<label class=\" form-control-label\">Chuyên m\u1EE5c</label>";
        tmp += "</div>";
        tmp += "<img id=\"loading-gif\" src=\"/adv/images/loading.gif\" style=\"max-width: 50px; display: none;\">";
        tmp += "<div class=\"form-group\">";
//        tmp += "<label class=\" form-control-label\">Xác \u0111\u1ECBnh thành ph\u1EA7n \u0111ánh giá</label><br>";
//        tmp += "</div>";
...
//            tmp += "<input type=\"text\" id=\"txt"+ standardAr +"\" name=\"txt"+ standardAr +"\" placeholder=\"Xác \u0111\u1ECBnh "+ item.getAr_name() +"\" class=\"form-control\">";
//            tmp += "</div>";
//        }
        tmp += "<center>";
        tmp +=
    ...
    public static String viewSourceShow(ArrayList<CategoryObject> items) {
        ...
        tmp += "<div class=\"card\">";
        tmp +=
                "<div class=\"card-header\"><strong>Thông tin chi ti\u1EBFt ngu\u1ED3n tin</strong>";
        tmp +=
        ...
        for (CategoryObject item : items) {
            if (NO == 0) {
                tmp += "<div class=\"form-group\">";
                tmp += "<label for=\"txtName\" class=\" form-control-label required\">Tên ngu\u1ED3n</label>";
                tmp += "<input type=\"text\" id=\"txtName\" name=\"txtName\" placeholder=\"Nh\u1EADp tên ngu\u1ED3n\" class=\"form-control\" value=" +
                ...
                tmp += "<div class=\"form-group\">";
                tmp += "<label for=\"txtCateSelector\" class=\" form-control-label required\">Xác \u0111\u1ECBnh chuyên m\u1EE5c</label>";
                tmp += "<input type=\"text\" id=\"txtCateSelector\" name=\"txtCateSelector\" placeholder=\"Nh\u1EADp CSS selector \u0111\u1EC3 xác \u0111\u1ECBnh chuyên m\u1EE5c c\u1EE7a ngu\u1ED3n\" class=\"form-control\" value=" +
        ...
        tmp += "<div class=\"form-group\">";
        tmp +=
                "<label for=\"txtCreatedDate\" class=\" form-control-label\">Ngày t\u1EA1o</label>";
        tmp +=
        ...
        tmp += "</div>";
        tmp += "<div class=\"form-group\">";
        tmp += "<label for=\"txtLastUpdatedDate\" class=\" form-control-label\">Ngày s\u1EEDa cu\u1ED1i</label>";
        tmp +=
