...
public class header extends HttpServlet {
    ...
    public void doGet(HttpServletRequest request, HttpServletResponse response) throws
        ...
        //////////////////////Thêm css,js tu cac user,category,...
        out.print(
        ...
        out.print("<ul class=\"nav navbar-nav menu-right\">");
        out.print("<li class=\"\">");

        out.print("<a href=\"/adv/view\"><i class=\"menu-icon fa fa-laptop\"></i>Th\u1ED1ng kê </a>");
        out.print("</li>");
        out.print("<li class=\"\">");
        out.print("<a href=\"/adv/source/view\"><i class=\"menu-icon fa fa-cogs\"></i>Ngu\u1ED3n tin </a>");
        out.print("</li>");
        out.print("<li class=\"\">");
        out.print("<a href=\"/adv/category/view\"><i class=\"menu-icon fa fa-book\"></i>Chuyên m\u1EE5c </a>");
        out.print("</li>");
//        out.print("<li class=\"\">");
//        out.print("<a href=\"/adv/framework_assessment/view\"><i class=\"menu-icon fa fa-id-card-o\"></i>Khung tiêu chí \u0111ánh giá </a>");
//        out.print("</li>");
//        out.print("<li class=\"\">");
//        out.print("<a href=\"/adv/assessment_rule/view\"><i class=\"menu-icon fa fa-map-o\"></i>Tiêu chí \u0111ánh giá </a>");
//        out.print("</li>");
        out.print("<li class=\"\">");
        out.print("<a href=\"/adv/article/view\"><i class=\"menu-icon fa fa-file-word-o\"></i>Bài vi\u1EBFt </a>");
        out.print("</li>");
        out.print("<li class=\"\">");
