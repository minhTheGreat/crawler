...
public class menu extends HttpServlet {
    ...
    public void doGet(HttpServletRequest request, HttpServletResponse response) throws
        ...
        out.print("<a class=\"nav-link\" href=\"#\"><i class=\"fa fa-user\"></i>Thông tin cá nhân</a>");

        out.print("<a class=\"nav-link\" href=\"#\"><i class=\"fa fa-bell-o\"></i>Thông báo <span class=\"count\">13</span></a>");
