...
public class UserAE extends HttpServlet {
    ...
    private void view(HttpServletRequest request, HttpServletResponse response) throws
        ...
        out.print("</div>");
        out.print("<center>");
        out.print("<input type=\"submit\" value=\""+lblSave+"\" class=\"btn btn-primary\" onClick=\"saveUser(this.form)\" /> &nbsp;>");
        out.print("</center>");
        out.print("</div>");
        out.print("</form>");
        out.print("</div>");
