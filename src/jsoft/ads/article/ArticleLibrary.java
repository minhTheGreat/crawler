...
public class ArticleLibrary {
    ...
    public static String viewArticles(ArrayList<ArticleObject> items) {
        ...
        tmp += "<tr>";
        tmp += "<th>STT</th>";
        tmp += "<th style=\"min-width: 151px\">Tiêu \u0111\u1EC1</th>";
        ...
        for (ArticleObject item : items) {
            ...
            if(item.isSource_enable() && item.isCategory_enable() && item.isArticle_enable()){
                ...
                tmp += "<td><div class=\"alert alert-danger\"><a href='enable?id="+item.getArticle_id()+"' class=\"cate-enable alert-link\">Không s\u1EED d\u1EE5ng</a></div></td>";
            }
